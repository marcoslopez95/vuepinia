<template>
    ...
    <VRow>
        ...
        <VCol cols="12" lg="6" class="my-6" style="height: 300px">
            <div
                class="d-flex flex-column mx-auto v-text-field__slot h-100"
                style="width: 300px"
            >
                <!-- <div class=" my-auto">
                    <VImg
                ...
                <div
                    class="d-flex flex-column mx-5 my-auto text-table font-weight-bold"
                >
                    <div class="d-flex justify-space-between">
                        <div>Titular:</div>
                        <div>
                            {{ accountDelivery.attributes.beneficiary }}
                        </div>
                    </div>
                    <div class="d-flex justify-space-between">
                        <div>Número de Cuenta:</div>
                        <div>
                            {{ accountDelivery.attributes.account_number }}
                        </div>
                    </div>
                    <div class="d-flex justify-space-between">
                        <div>documento:</div>
                    ...
                    <div class="d-flex justify-space-between">
                        <div>Teléfono:</div>
                        <div>{{ accountDelivery.attributes.phone }}</div>
                    </div>
                    <div class="d-flex justify-space-between">
                        <div>Tipo:</div>
                        <div>
                            {{ accountDelivery.attributes.description }}
                        </div>
                    </div>
                </div>
            </div>
...
const accountDelivery = order.value.relationships
    ?.account_delivery as OtherAccount;
