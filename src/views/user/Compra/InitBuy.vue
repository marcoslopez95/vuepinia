...
const clickInContinue = () => {
    ...
    form.value.total_exchange_local = calculatorValue.value.amountFiat
    form.value.currency_price = calculatorValue.value.tasaCompra
    form.value.exchange_reference = calculatorValue.value.criptoOficial
    form.value.total_exchange_reference = calculatorValue.value.amountUsd
    form.value.exchange_local = calculatorValue.value.localOficial
    form.value.total_exchange_local = calculatorValue.value.amountFiat
    form.value.amount_currency = calculatorValue.value.amountCrypto
    form.value.received_amount = parseFloat(form.value.amount_currency as string) + parseFloat(form.value.fee as string)
