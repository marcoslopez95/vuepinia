...
// import { useRecaptchaProvider } from 'vue-recaptcha/dist/head'
        ...
        >
            <template #default="{ isValid }">
                <VRow>
                    <VCol cols="12">
                        <InputComponent
                            :placeholder="$t('views.users.username')"
                            withoutLabel
                    ...
                    <VCol cols="12">
                        <InputComponent
                            :events="eventOnlyLetter"
                            :placeholder="$t('views.users.first_name')"
                            withoutLabel
                            :name="$t('views.users.first_name')"
                    ...
                    <VCol cols="12">
                        <InputComponent
                            :events="eventOnlyLetter"
                            :placeholder="$t('views.users.last_name')"
                            withoutLabel
                            :name="$t('views.users.last_name')"
                    ...
                    <VCol cols="12">
                        <TelInput
                            ...
                            :placeholder="
                                $t('views.profile.personal-data.phone')
                            "
                            without-label
                        />
                    </VCol>
                    ...
                    <VCol cols="12">
                        <InputComponent
                            withoutLabel
                            :placeholder="
                                $t('views.users.password-confirmation')
                            "
                            ...
                            :type="
                                !showPasswordConfirmation ? 'password' : 'text'
                            "
                            :appendIcon="
                ...
                <VCheckbox v-model="accepTerms">
                    <template #label>
                        <div
                            v-html="
                                $t('views.register.accept-terms-and-conditions')
                            "
                        ></div>
                    </template>
                </VCheckbox>
                <div class="text-center mt-1">
                    <VBtnPrimary
                        @click="SigUp"
                        :disabled="!accepTerms || !isValid.value"
                    >
